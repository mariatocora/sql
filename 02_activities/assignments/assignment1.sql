...
-- Comment: There are not product IDs 9
...
--Comment: There are not vendor IDs 9 and 10. 
...
*/
-- DROP TABLE IF EXISTS new_vendor; --I included this part of the code becuase I ran it multiple times
